...
import 'package:fzwm/views/quality/receiving_materials_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

final String _fontFamily = Platform.isWindows ? "Roboto" : "";

class ReceivingMaterialsPage extends StatefulWidget {
  ReceivingMaterialsPage({Key ?key}) : super(key: key);

  @override
  _ReturnGoodsPageState createState() => _ReturnGoodsPageState();
}

class _ReturnGoodsPageState extends State<ReceivingMaterialsPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    if(this._dateSelectText != ""){
      ...
      userMap['FilterString'] = "FENTRYSTATUS = 'A' and FActReceiveQty-FCheckQty>0 and FCheckInComing=1 and FDocumentStatus = 'C' and FDate>= '$startDate' and FDate <= '$endDate' and FPurOrgId.FNumber = '"+tissue+"'";
    }
    if(this.isScan){
      if (this.keyWord != '') {
        userMap['FilterString'] = "FBillNo like '%"+keyWord+"%' and FActReceiveQty-FCheckQty>0 and FCheckInComing=1 and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FPurOrgId.FNumber = '"+tissue+"'";
      }
    }else{
      if (this.keyWord != '') {
        userMap['FilterString'] = "FBillNo like '%"+keyWord+"%' and FActReceiveQty-FCheckQty>0 and FCheckInComing=1 and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FPurOrgId.FNumber = '"+tissue+"'";
        ...
        if (this._dateSelectText != "") {
          userMap['FilterString'] = "FCheckInComing=1 and FActReceiveQty-FCheckQty>0 and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FDate>= '$startDate' and FDate <= '$endDate' and FPurOrgId.FNumber = '"+tissue+"'";
        }else{
          userMap['FilterString'] = "FCheckInComing=1 and FActReceiveQty-FCheckQty>0 and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FPurOrgId.FNumber = '"+tissue+"'";
        }
      }
    }
    this.isScan = false;
    ...
    userMap['Limit'] = '20';
    userMap['FieldKeys'] =
    'FBillNo,FSupplierId.FNumber,FSupplierId.FName,FDate,FDetailEntity_FEntryId,FMaterialId.FNumber,FMaterialId.FName,FMaterialId.FSpecification,FPurOrgId.FNumber,FPurOrgId.FName,FUnitId.FNumber,FUnitId.FName,FActReceiveQty,FSrcBillNo,FID,FCheckQty,FApproveDate';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ReceivingMaterialsDetail(FBillNo:this.hobby[i][0]['value']
                            // 路由参数
                          );
                        },
                      ),
