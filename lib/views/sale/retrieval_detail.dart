          ...
          if (hobby == 'customer') {
            ...
            data.forEach((element) {
              if (element == p) {
                ...
                stock[13]['value']['hide'] = stockListObj[elementIndex][3];
              }
              elementIndex++;
            });
          }
    ...
    if (this.hobby.length > 0) {
      ...
      this.hobby.forEach((element) {
        if (element[8]['value']['value'] != '0' &&
          ...
          FEntityItem['F_ora_Assistant'] = {"FNumber": element[12]['value']['value']};
