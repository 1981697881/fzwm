...
class _PurchaseWarehousingDetailState extends State<PurchaseWarehousingDetail> {
    ...
    if (orderDate.length > 0) {
      ...
      orderDate.forEach((value) {
        ...
        arr.add({
          ...
          "name": "FMaterial",
          "FSRCBillNo": value[19],
          "FSrcEntryId": value[20],
          "FOrderBillNo": value[21],
          "FTaxPrice": value[22],
          "FEntryTaxRate": value[23],
          "FNote": value[24],
          "FGiveAway": value[25],
          "FID": value[14],
          "FEntryId": value[4],
  ...
  saveOrder() async {
    if (this.hobby.length > 0) {
      ...
      //判断有源单 无源单
      if(this.isScanWork){
        Model['FPurchaseOrgId'] = {"FNumber": deptData[1]};
      ...
      this.hobby.forEach((element) {
        if (element[3]['value']['value'] != '0' &&
          ...
          FEntityItem['FCheckInComing'] = true;
